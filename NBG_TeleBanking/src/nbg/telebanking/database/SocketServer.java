...
//    static SQLProvider accessor =new SQLProvider();
            ...
            while (true) {
                ...
                do {
                    try {
                        ...
                        } else if (action.equals("search transaction")) {
                            System.out.println("");

                        } else if (action.equals("view chart for debit")) {
                            System.out.println("");

                        } else if (action.equals("view chart for credit")) {
                            System.out.println("");
                        ...
                        } else if (action.equals("Open chat client")) {
                            System.out.println("");

                        } else if (action.equals("add funds")) {
                            System.out.println("");

                        } else if (action.equals("transfer funds")) {
                            System.out.println("");
